    ...
    <div class="row align-items-center h-100">
        <div class="col-md-4 pb-2">
            <div class="text-center">
                <img class="rounded-circle" width="100" height="100" src="<?php echo $this->user_model->get_user_image($student['user_id']); ?>">
                <br><br><br>
            ...
            <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <table class="table table-centered mb-0">
                        <tbody>
                            ...
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('roll'); ?>:</td>
                                <td><?php echo $this->user_model->get_user_details($student['user_id'], 'roll'); ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('blood_group'); ?>:</td>
                                <td><?php echo $this->user_model->get_user_details($student['user_id'], 'blood_group'); ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('date_of_birth'); ?>:</td>
                                <td><?php echo $this->user_model->get_user_details($student['user_id'], 'birthday'); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                <div class="tab-pane fade show" id="parent_info" role="tabpanel" aria-labelledby="parent-tab">
                    <table class="table table-centered mb-0">
                        <tbody>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('father_name'); ?>:</td>
                                <td><?php echo $this->user_model->get_user_details($student['user_id'], 'father_name'); ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('mother_name'); ?>:</td>
                                <td><?php echo $this->user_model->get_user_details($student['user_id'], 'mother_name'); ?></td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('guardian_name'); ?>:</td>
                                <td>
                                    <?php echo $this->user_model->get_user_details($parent['user_id'], 'name'); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('guardian_address'); ?>:</td>
                                <td>
                                    <?php echo $this->user_model->get_user_details($parent['user_id'], 'address'); ?>
                                </td>
                            </tr>
                            <tr>
                                <td style="font-weight: bold;"><?php echo get_phrase('guardian_phone_number'); ?>:</td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td><?php echo $this->user_model->get_user_details($student['user_id'], 'phone'); ?></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
